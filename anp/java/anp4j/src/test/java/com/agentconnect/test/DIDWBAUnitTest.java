...
public class DIDWBAUnitTest {
    ...
    @Test
    @Disabled("Requires network access and valid certificate")
    ...
    @Test
    @Disabled("Requires user-specific DID document and private key files")
    ...
    @Test
    @Disabled("Requires user-specific DID document, private key files, and network access")
